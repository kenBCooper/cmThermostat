...
export const UPDATE_TEMP_FORMAT = 'UPDATE_TEMP_FORMAT';
...
export const SET_CURRENT_GENX = 'SET_CURRENT_GENX';

/**
* Action Verbs Explained:
* Update - making changes to the remote device shadow and local state
